...
<details>
    ...
    <ul>
        ...
        <li><b>Vedic Numerology Calculator</b> - A full-stack web application that gives comprehensive Vedic numerology report, automating complex calculations including Mahadasha, Antardasha, and Pratyantara Dasha periods, planetary yogas (51 combinations), numerological strength analysis & much more. Built with Vue.js frontend and Flask/Python backend, featuring user authentication, role-based access (admin/user), this calculator reduces manual calculation time from hours to seconds for numerology practitioners. I'm adding more features with time in this app.
        </li>
